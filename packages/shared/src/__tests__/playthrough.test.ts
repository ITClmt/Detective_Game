 ...
 */
// Tout le fichier dépend de `content/verdier.json`, gitignoré (voir
// verdier-json.ts) — `skipIf` plutôt qu'un crash à l'import sur un clone qui
// ne l'a pas.
describe.skipIf(!verdierFixtureExists)(
	"parcours complet — affaire Verdier",
	() => {
